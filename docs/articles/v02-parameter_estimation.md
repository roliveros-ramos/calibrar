...
#> opt0     LBFGSB3  0.0903 1.51e+05    18  18 0.402 1181 600
#> opt1      Rvmmin  0.0162 1.35e+07   161   8 2.900 1145 482
#> opt2          CG  0.0804 1.51e+05   691 101 0.402 1181 600
#> opt3      AHR-ES  1.8073 6.78e-17 11130   0 0.500 1000 600
#> opt4      CMA-ES  0.0866 1.07e+05  1085  NA 0.446 1090 689
#> opt5         hjn  0.3836 9.91e+02  6000  NA 0.509  988 602
#> opt6 Nelder-Mead  0.0128 7.76e-02   221  NA 0.500 1000 600
```
...
#> lbfgsb1 L-BFGS-B    60.1 -186093 2082 2082 0.430 -0.415 -0.1085
#> lbfgsb2   Rvmmin    12.6 -186095 2701  425 0.397 -0.415 -0.0755
#> lbfgsb3  LBFGSB3    40.3 -186092 1376 1376 0.417 -0.415 -0.0863
```
...
#> ARPM         data      NA -186178   NA   NA 0.400 -0.400 -0.1253
#> lbfgsb1  L-BFGS-B    60.1 -186093 2082 2082 0.430 -0.415 -0.1085
#> lbfgsb1p L-BFGS-B    58.0 -186095 1998 1998 0.402 -0.414 -0.0807
#> lbfgsb2    Rvmmin    12.6 -186095 2701  425 0.397 -0.415 -0.0755
#> lbfgsb2p   Rvmmin     9.7 -186095 2080  329 0.396 -0.415 -0.0743
#> lbfgsb3   LBFGSB3    40.3 -186092 1376 1376 0.417 -0.415 -0.0863
#> lbfgsb3p  LBFGSB3    60.6 -186095 2215 2215 0.398 -0.415 -0.0754
```
...
#>          method elapsed   value   fn  gr alpha   beta  gamma1
#> ARPM       data      NA -186178   NA  NA 0.400 -0.400 -0.1253
#> lbfgsb2  Rvmmin   12.64 -186095 2701 425 0.397 -0.415 -0.0755
#> lbfgsb2p Rvmmin    9.70 -186095 2080 329 0.396 -0.415 -0.0743
#> mix1     Rvmmin   18.51 -186095 4011 590 0.396 -0.415 -0.0739
#> mix2     Rvmmin   19.88 -186095 4011 693 0.396 -0.415 -0.0740
#> mix3     Rvmmin    5.99 -186095  729 212 0.396 -0.415 -0.0746
```
